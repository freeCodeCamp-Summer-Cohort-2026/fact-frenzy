...
export default function Header() {
	return (
		<header className="w-full mx-auto max-w-6xl px-8">
			<nav className="flex h-13 items-center justify-between gap-3 bg-white/80 px-6">
				{/* navigation links */}
				...
				<ul className="flex flex-1 text-lg font-semibold items-center justify-end gap-3">
					<li>
						<Link
							href="/login"
							className="flex h-10 w-full items-center justify-center gap-2 rounded-full bg-[#A60362] px-4 text-gray-50 transition-colors hover:bg-slate-700"
						>
							Login / Sign Up
						</Link>
					</li>
